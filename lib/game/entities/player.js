...
.defines(function() {
    ...
    EntityPlayer = ig.Entity.extend({
        ...
        init: function(x, y, settings) {
            ...
            //New animation set
            this.addAnim('default', 1, [0]);
            this.addAnim('animU', 0.1, [0, 1, 2, 3]); //use .flip.y for down
            this.addAnim('animR', 0.1, [4, 5, 6, 7]); //use .flip.x for left
            this.addAnim('animU_C', 0.1, [8, 9, 10, 11]);
            this.addAnim('animR_C', 0.1, [12, 13, 14, 15]);
            this.addAnim('animU_F', 0.1, [16, 17, 18, 19]);
            this.addAnim('animR_F', 0.1, [20, 21, 22, 23]);
