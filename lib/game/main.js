...
EDeck = ig.Game.extend({
    ...
    borderFont: new ig.Font('media/font.png', {borderColor: '#FFF'}),
    ...
    setUpEvent: function() {
        ...
        // this.myNoteMgr.spawn('media/04b03.font.png', this.currEvent.captiansOrd[this.eventNum],  6, (this.font.height*6), ig.Font.ALIGN.LEFT);
         //this.myNoteMgr.spawn('media/font.png', hello world,  6, (this.font.height*6), ig.Font.ALIGN.LEFT);
         //this.myNoteMgr.draw();
...
MenuScreen = ig.Game.extend({
    ...
    draw: function() {
        ...
        var x = 5;
        var y = 35;
        this.font.draw('[#5F04B4 <SPACE>] START GAME', x, y + this.font.height);
        this.font.draw('[#5F04B4 <I>] INSTRUCTIONS', x, y + this.font.height*2 + 3);
        this.font.draw('[#5F04B4 <C>] CREDITS', x, y + this.font.height*3 + 6);
...
InstructionScreen = ig.Game.extend({
    ...
    draw: function() {
        ...
        this.font.draw('USE [#FF0000 WASD] OR [#FF0000 ARROWS] TO MOVE.', x, y);
        this.font.draw('PRESS [#FF0000 SPACE] OR [#FF0000 E] TO PICK UP', x, y + fh*2);
        this.font.draw('CORES AND ACTIVATE SYSTEMS.', x, y + fh*3);
        this.font.draw('PRESS [#FF0000 F] TO DROP A HELD CORE.', x, y + fh*5)
        this.font.draw('[#FF0000 <ESC>] MENU', x, ig.system.height - 29);
    }
});
...
CreditScreen = ig.Game.extend({
    font: new ig.Font('media/font.png', {fontColor: '#0B0B3B'}),
    borderFont: new ig.Font('media/font.png', {fontColor: '#FFF', borderColor: '#F00'}),
    ...
    draw: function() {
        ...
        this.borderFont.draw('Kevin McCotter', x, y + fh);
        this.font.draw('CODE/MISSION DESIGN:', x, y + fh*3);
        this.borderFont.draw('Andrew Miller', x, y + fh*4);
        this.font.draw('SOUND DESIGN:', x, y + fh*6);
        this.borderFont.draw('Robert Ho', x, y + fh*7);
        this.font.draw('GRAPHICAL DESIGN:', x, y + fh*9);
        this.borderFont.draw('Martina Stepisnik', x, y + fh*10);
		this.font.draw('[#5F04B4 <ESC>] MENU', x, ig.system.height - 30);
    }
});
