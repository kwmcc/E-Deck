...
EDeck = ig.Game.extend({
    ...
    draw: function() {
        ...
        this.newEvent = false;
        eventNum++; //need to check for array out of bounds.
    ...
    checkingEv : function() {
            ...
            if(this.eventTime > this.timeAllocated-1){
                ...
                if(system.isHeating){
                    ...
                    /*
                //set primary system
                if(sysEngines.isPrimary){
                    system = sysEngines;
                    console.log("Eng. is primary.");
                }else if(sysShields.isPrimary){
                    system = sysShields;
                    console.log("sheild is primary.");
                }else if(sysCloaking.isPrimary){
                    system = sysCloaking;
                    console.log("cloak is primary.");
                }else if(sysWeapons.isPrimary){
                    system = sysWeapons;
                    console.log("wep. is primary.");
                }else if(sysLifesupport.isPrimary){
                    system = sysLifesupport;
                    console.log("LS is primary.");
                }else if(sysSensors.isPrimary){
                    system = sysSensors;
                    console.log("sensors is primary.");
                }else{
                    console.log("no primary system found.");
