...
EDeck = ig.Game.extend({
    ...
    pager : new ig.Sound('media/audio/pager.*'),
    secSound : new ig.Sound('media/audio/security_system.*'),
    ...
    draw: function() {
        ...
        if(player.hasMoved){
            ...
            if(this.eventNum > this.numEvents){
                console.log("Event is out of Bounds.");
                this.gameStatus = 2;
            }
    ...
    checkingEv : function() {
            ...
            if(this.eventTime > this.timeAllocated-1){
                ...
                if(this.primarySystem == 'Out of Bounds!'){
                    this.gameStatus = 2;
                    ig.system.setGame(GameOverScreen) 
                }
