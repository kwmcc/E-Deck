...
EDeck = ig.Game.extend({
    ...
    update: function() {
        ...
        if(ig.input.pressed('orders') && !this.ordersScreen) {
        	...
        	ig.music.pause();
        } else if(ig.input.pressed('orders') && this.ordersScreen) {
        	this.ordersScreen = false;
        	ig.music.play();
        }
        if(ig.input.pressed('info') && !this.infoScreen) {
        	...
        	ig.music.pause();
        } else if(ig.input.pressed('info') && this.infoScreen) {
    ...
    draw: function() {
		...
		if(this.infoScreen) {
			...
			this.imgShields.draw(5,y,0,0,32,32);
			this.imgCloaking.draw(5,y + si,0,0,32,32);
			this.imgEngines.draw(5,y + si*2,0,0,32,32);
			this.imgWeapons.draw(x,y,0,0,32,32);
			this.imgLifeSupport.draw(x,y + si,0,0,32,32);
			this.imgSensors.draw(x,y + si*2,0,0,32,32);
			this.imgFuel.draw(5, 150);
			this.font.draw("FUEL CORE", 25, 155);
			this.imgCool.draw(5, 170);
			this.font.draw("COOLANT CORE", 25, 175);
...
GameOverScreen = ig.Game.extend({
    ...
    draw: function() {
        ...
        var x = ig.system.width/2;
        var y = ig.system.height/2;
        if(this.determine()) this.dayumShame.draw(x - this.dayumShame.width/2, y - this.dayumShame.height/2);
