...
EDeck = ig.Game.extend({
    ...
    iconFuelOn: new ig.Image( 'media/powericonon.png'),
    iconFuelOff: new ig.Image( 'media/powericonoff.png'),
    iconCoolOn: new ig.Image( 'media/cooliconon.png'),
    iconCoolOff: new ig.Image( 'media/cooliconoff.png'),
